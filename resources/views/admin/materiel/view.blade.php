        ...
        <div class="xl:w-[80%] sm:w-[85%] xs:w-[90%] mx-auto flex md:flex-row xs:flex-col lg:gap-4 xs:gap-2 justify-center lg:items-stretch md:items-center mt-4">
            ...
            <div class="lg:w-[50%] sm:w-full xs:w-full bg-gray-100 md:p-4 xs:p-2 rounded-md">
                ...
                <div>
                    ...
                    <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                        <p class="text-gray-600">Manufacturer</p>
                    ...
                    <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                        <p class="text-gray-600">Inventory Number</p>
                        <p>{{ $materiel->n_inventaire }}</p>
                    </div>
                    <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                        <p class="text-gray-600">Market Number</p>
                        <p>{{ $materiel->n_marchee }}</p>
                    </div>
                    <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                        <p class="text-gray-600">Date of Service</p>
                ...
                <div class="mt-4 flex gap-2">
                    <a href="{{ route('materiels.edit', $materiel->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Edit</a>
                    ...
                    <a href="{{ route('materiels.interventions', $materiel->id) }}" class="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full">View Interventions</a>
                    <a href="{{ route('materiels') }}" class="inline-block bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full">Back to List</a>
                </div>
            </div>
        </div>
    </section>
